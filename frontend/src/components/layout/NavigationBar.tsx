...
const NavigationBar = () => {
  ...
  return (
    <nav className='fixed bottom-0 z-40 flex h-[70px] w-full max-w-mobile items-center justify-around rounded-t-2xl bg-white shadow-[4px_4px_16px_12px_rgba(0,0,0,0.04)]'>
      {/* Home */}
      <button
