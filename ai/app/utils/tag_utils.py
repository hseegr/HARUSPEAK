...
- 일기 내용의 의미를 해석할 수 없는 컨텐츠의 경우 "아무말"을 출력해주세요. 그러나 "안녕하세요> ㅎㅎj" 처럼 대략적으로라도 해석할 수 있으면 태그 추천해주세요.
- 단어 하나만 적힌 경우에, 그 단어가 실제 존재하는 단어라면 "아무말"을 출력하지 말고 다른 단어를 추천해주세요.
...
async def oa_generate_tag(
    ...
    count = 3 - tag_len
    guide_text = f"-반드시 총 {count}개의 키워드를 추출해 주세요. \n-단 {tags} 은 제외하고 추천해주세요."
